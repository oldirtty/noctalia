...
namespace noctalia::ipc {
  ...
  inline constexpr CliPositional kBarAutoHideSetPositionals[] = {
      {.name = "state", .description = "auto-hide state", .choices = kAutoHideStates, .required = true},
  ...
  inline constexpr CliPositional kClipboardCopyPositionals[] = {
      {.name = "text", .description = "text to copy", .required = true, .consumesRemaining = true}
  };
  ...
  inline constexpr CliPositional kNotificationDndSetPositionals[] = {
      {.name = "state", .description = "dnd state", .choices = kBooleanStates, .required = true}
  };

  // msg notification-show <summary> <body>
  inline constexpr CliPositional kNotificationPositionals[] = {
      {.name = "summary", .description = "notification summary", .required = true},
      {.name = "body",
       .description = "notification body",
       .required = true,
       .consumesRemaining = true} // SOLVES THE REGRESSION!
  };
  ...
  inline constexpr CliPositional kPluginPositionals[] = {
      ...
      {.name = "payload", .description = "optional JSON payload", .required = false, .consumesRemaining = true}
  };
  ...
  inline constexpr CliPositional kThemeModePositionals[] = {
      {.name = "mode", .description = "theme mode", .choices = kThemeModes, .required = true}
  };
  ...
  inline constexpr CliPositional kWorkspaceAlertAddWindowPositionals[] = {
      {.name = "window", .description = "window id/title", .required = true, .consumesRemaining = true}
  };
  ...
  inline constexpr CliPositional kWorkspacePositionals[] = {
      {.name = "workspace", .description = "workspace index or name", .required = true}
  };
  ...
  inline constexpr CliCommand kIpcSubcommands[] = {
      ...
      {.name = "bar-show", .summary = "Show one or all bars", .positionals = kBarShowPositionals},
      {.name = "bar-toggle", .summary = "Toggle visibility for one or all bars", .positionals = kBarTogglePositionals},
      ...
      {.name = "brightness-down", .summary = "Decrease brightness", .positionals = kStepOptionalPositionals},
      ...
      {.name = "brightness-set", .summary = "Set brightness", .positionals = kBrightnessSetPositionals},
      {.name = "brightness-up", .summary = "Increase brightness", .positionals = kStepOptionalPositionals},
      ...
      {.name = "mic-volume-down", .summary = "Decrease microphone volume", .positionals = kStepOptionalPositionals},
      {.name = "mic-volume-osd", .summary = "Show the microphone volume OSD", .positionals = kOptionalValuePositionals},
      {.name = "mic-volume-set", .summary = "Set microphone volume", .positionals = kMicVolumeSetPositionals},
      {.name = "mic-volume-up", .summary = "Increase microphone volume", .positionals = kStepOptionalPositionals},
      ...
      {.name = "panel-open", .summary = "Open a panel by id", .positionals = kPanelOpenTogglePositionals},
      {.name = "panel-toggle", .summary = "Toggle a panel by id", .positionals = kPanelOpenTogglePositionals},
      {.name = "plugin", .summary = "Dispatch an event to a plugin entry", .positionals = kPluginPositionals},
      ...
      {.name = "settings-open", .summary = "Open the settings window", .positionals = kSettingsContextPositionals},
      ...
      {.name = "settings-toggle", .summary = "Toggle the settings window", .positionals = kSettingsContextPositionals},
      ...
      {.name = "volume-down", .summary = "Decrease speaker volume", .positionals = kStepOptionalPositionals},
      {.name = "volume-mute", .summary = "Toggle speaker mute"},
      {.name = "volume-osd", .summary = "Show the volume OSD", .positionals = kOptionalValuePositionals},
      {.name = "volume-set", .summary = "Set speaker volume", .positionals = kVolumeSetPositionals},
      {.name = "volume-up", .summary = "Increase speaker volume", .positionals = kStepOptionalPositionals},
      {.name = "wallpaper-get",
