...
namespace noctalia::config {
  ...
  constexpr const char* kConfigHelpText =
  ...
  constexpr std::string_view kExportChoices[] = {"merged", "full"};

  constexpr cli_schema::CliPositional kValidatePositionals[] = {
      {.name = "path", .description = "config file or directory", .required = false},
  };

  constexpr cli_schema::CliPositional kExportPositionals[] = {
      {.name = "mode",
  ...
  constexpr cli_schema::CliPositional kReplayPositionals[] = {
      {.name = "report.toml",
  ...
  constexpr cli_schema::CliFlag kReplayFlags[] = {
      {.longName = "--target",
  ...
  extern constexpr cli_schema::CliCommand kValidateCmd = {
      .name = "validate",
  ...
  extern constexpr cli_schema::CliCommand kExportCmd = {
      .name = "export",
  ...
  extern constexpr cli_schema::CliCommand kSettingsCountCmd = {
      .name = "settings-count",
      .summary = "Count Settings UI controls",
      .helpText = kSettingsCountHelpText,
  };

  extern constexpr cli_schema::CliCommand kReplayReportCmd = {
      .name = "replay-report",
  ...
  constexpr cli_schema::CliCommand kConfigSubcommands[] = {
      kValidateCmd,
      kExportCmd,
      kSettingsCountCmd,
      kReplayReportCmd
  ...
  extern constexpr cli_schema::CliCommand kConfigCmd = {
      .name = "config",
